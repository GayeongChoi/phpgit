    ...
    echo "<div class='blog__label' style='background-image:url(../assets/img/blog/".$blogInfo['blogImgFile'].");'>
          ...
          <div class='container'>
              <div class='blog__layout'>
                  ...
                  <iframe src='https://ads-partners.coupang.com/widgets.html?id=572090&template=carousel&trackingCode=AF1974318&subId=&width=300&height=300' width='300' height='300' frameborder='0' scrolling='no' referrerpolicy='unsafe-url'></iframe>
                  </div>
              </div>
          </div>";
?>
