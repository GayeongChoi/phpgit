        ...
        <section id="quiz-type" class="section center gray">
            <div class="container">
                ...
                <p class="section__desc">
                    문제를 만들고 같이 공유하고, 같이 공부 할 수 있습니다.
                </p>
                        ...
                        <form action="quizCreateSave.php" name="quizCreate" method="post">
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="quizChoice1" placeholder="보기 1번을 작성해주세요!" required>
                                    <label for="quizChoice2">보기2</label>
                                    <input type="text" id="quizChoice2" placeholder="보기 2번을 작성해주세요!" required>
                                    <label for="quizChoice3">보기3</label>
                                    <input type="text" id="quizChoice3" placeholder="보기 3번을 작성해주세요!" required>
                                    <label for="quizChoice4">보기4</label>
                                    <input type="text" id="quizChoice4" placeholder="보기 4번을 작성해주세요!" required>
                                </div>
                                <div>
                                ...
                                <div class="quiz__btn">
                                    <button type="submit" class="purple right">저장하기</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
