...
<body>
    <?php  
        ...
        // $memberID = $_SESSION['memberID'];
        // $boardTitle = $_POST['boardTitle'];
        // $boardContents = $_POST['boardContens'];
        // $boardView = 1;
        // $regTime = time();
        // $boardTitle = $connect -> real_escape_string($boardTitle);
        // $boardContents = $connect -> real_escape_string($boardContents);
        // //echo $memberID,$boardTitle,$boardContens,$boardView,$regTime
        // $spl = "INSERT INTO myBoard(memberID,boardTitle,boardContents,boardview,regTime) 
        //         VALUES('$memberID','$boardTitle','$boardContents','$boardView','$regTime')";
        // $connect -> query($sql);
        // Header("Location:../board/board.php");
