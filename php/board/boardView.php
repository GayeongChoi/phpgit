...
<body>
    ...
    <main id="contents">
        ...
        <section id="board-type" class="section center mb100">
            <div class="container">
                <h3 class="section__title">퀴즈 게시판</h3>
                <p class="section__desc">퀴즈와 관련된 게시판입니다. 궁금한 점은 여기를 확인하세요!</p>
...
<?php
    ...
    if($result){
        ...
        echo "<tr><th>등록일</th><td class='left'>".date('Y-m-d', $boardInfo['regTime'])."</td></tr>";
        echo "<tr><th>조회수</th><td class='left'>".$boardInfo['boardView']."</td></tr>";
        echo "<tr><th>내용</th><td class='left height'>".$data2."</td></tr>";
    }
?>
